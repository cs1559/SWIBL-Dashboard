...
select teamid, dm.season as seasonid, t.name as teamname, t.coachname, d.agegroup as agegroup, d.name as divisionname, regular, substitute, total_players
from (
	select teamid, season, sum(regular) as regular, sum(substitute) as substitute, sum(total_players) as total_players
	from (
...
UNION ALL
select t.id as teamid, dm.season as seasonid, t.name, t.coachname, d.agegroup, d.name as division_name, 0, 0, 0
from 
